 ...
 * @author Hoang Anh
 */
@WebServlet(name = "DeleteBrandControl", urlPatterns = {"/deletebrand"})
public class DeleteBrandControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a != null) {
            if (a.getIsAdmin() == 1) {
                mp.deleteBrand(bid);
                request.setAttribute("messBrand", "This brand has been deleted successfully");
